...
export default {
  route: {
    ...
    sell: 'Sell',
    cardSellingManagement: 'Card Selling Management',
    system: 'System',
    ...
    course: 'Course',
    courseSchedul: 'Course Schedul',
    privateCourse: 'Private Course',
    membershipCard: 'Membership Card',
    mtOpenCard: 'MT Open Offline',
    finance: 'Finance',
    orderManagement: 'Order Management',
    advanceCollectionManagement: 'Advance Collection Management',
  ...
  login: {
	...
	thirdpartyTips: 'Third PartyTips'
  },
  documentation: {
    documentation: 'Documentation',
